                            ...
                            <td align="center" valign="top" bgcolor="#FFFFFF"><table width="94%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:20px;">
                                            ...
                                            <p>You have an inquiry for an appointment on <?php echo $start_date.' to '.$end_date; ?> for the property <?php echo $property_ref_no; ?> Inquiry from : <?php echo $customer_name.', Mobile Number: +'.$customer_mobile; ?></p>
