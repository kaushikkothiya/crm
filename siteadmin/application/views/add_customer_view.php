...
<li><?php echo anchor('home/add_customer/'.$id, 'Edit Client', "title='Edit Client'"); ?> 
<?php } else { ?>
<li><?php echo anchor('home/add_customer', 'Add Client', "title='Add Client'"); ?> 
<?php } ?>
<span class="divider">/
</span></li>
</ul>
...
<!-- <div class="control-group">
<label class="control-label" for="textarea">Aquired :
</label>
...
?>
<label class="radio">
<?php echo form_radio($status, 'buy', $checked2, 'class="radio_buttons required"'); ?>
Buy</label>
<label class="radio">
<?php echo form_radio($status, 'rent', $checked1, 'class="radio_buttons required"'); ?>
Rent</label>
...
?>
<?php echo anchor('home/customer_manage', 'Cancel', array('title' => 'Cancel', 'class' => 'btn span4')); ?>
</div>
</div>
</fieldset>
</form>
