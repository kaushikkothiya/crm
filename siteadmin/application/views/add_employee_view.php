				...
				?>
	              ...
	              <div class="form-group">
                    ...
                    <?php
						if ($id=="") {
 					?>
 					 <input type="submit" class="btn btn-sm btn-primary" value="Add Employee" name="employee_form" id="employee_form">
                    <?php } else { ?>  	
                    <input type="submit" class="btn btn-sm btn-primary" value="Update Employee" name="employee_form" id="employee_form">
                    <?php } 
                     echo anchor('home/employee_manage', 'Cancel', array('title' => 'Cancel', 'class' => 'btn btn-sm btn-default')); ?> 
                    </div>
                  </div>
                </form>
              </div>
