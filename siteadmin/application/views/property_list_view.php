...
<div class="container-fluid">
    ...
    <?php } ?>
        <h1 class="page-header">Property List
          ...
          <a><button data-toggle="modal" data-target="#myModal1" class="btn btn-sm btn-info pull-right" style="margin-left:5px;" type="button">Import Excel File</button></a>
          <a><button class="btn btn-sm btn-danger pull-right property_next" style="margin-left:5px;" type="button">Search</button></a>
          <?php } ?>
          <button class="btn btn-sm btn-info pull-right" type="button" onClick="window.location.href = 'add_property';">Create Property</button>
        </h1>
        ...
        <div class="col-md-6">
                      ...
                      <select name="view_inc"  id="view_inc" class="form-control" style="width:200px" onchange="view_property_agent(this.value);">
                            ...
                            <option value="<?php echo $value->id;?>" <?php if(!empty($_GET['view_agent']) && $_GET['view_agent']== $value->id) { echo "selected"; } ?> ><?php echo $value->fname.' '.$value->lname;?></option>
                            <?php }?>
                          </select>
                      </span> 
