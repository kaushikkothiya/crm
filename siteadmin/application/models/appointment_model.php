...
Class Appointment_model extends CI_Model {
  ...
  function get_days_appointments() {
        ...
        $day_end = date('Y-m-d 23:59:59');
          ...
          $q = $this->db->select("inquiry.*,user.id as agent_id,user.fname as agent_fname,user.lname as agent_lname,user.mobile_no as agent_mobile_no,user.coutry_code as agent_coutry_code,customer.fname as customer_fname,customer.lname as customer_lname,customer.mobile_no as customer_mobile_no,customer.coutry_code as customer_coutry_code,customer.id as customer_id")
                ->from('inquiry')
