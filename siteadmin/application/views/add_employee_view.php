...
<li><?php echo anchor('home/employee_manage', 'Employee Manage', "title='Employee Manage'"); ?>
<span class="divider">/
</span></li>
<?php if ($this->uri->segment(3)) { ?>
<li><?php echo anchor('home/add_employee/'.$id, 'Edit Employee', "title='Edit Employee'"); ?> 
<?php } else { ?>						
<li><?php echo anchor('home/add_employee', 'Add Employee', "title='Add Employee'"); ?> 
<?php } ?>
<span class="divider">/
</span></li>
</ul>
...
<?php echo form_open_multipart('verification/create_employee', array('class' => 'form-horizontal')); ?>
<fieldset>
<input type="hidden" id="employee_id" name="employee_id" value="<?php if(isset($id) && !empty($id)){ echo $id; } ?>">
...
?>
<div class="error"><?php //echo form_error('country_id'); ?></div>
...
?>
<div class="error"><?php //echo form_error('city_id'); ?></div>
...
<?php
if ($id=="") {
	//echo form_submit('submit', 'Create Employee', "class='btn span5'");
?>
<input type="submit" class="btn span5" value="Add Employee" name="employee_form" id="employee_form">
<?php } else { 
	//echo form_submit('submit', 'Update Employee', "class='btn span5'");
	?>
	<input type="submit" class="btn span5" value="Update Employee" name="employee_form" id="employee_form">
	<?php
}
?>
<?php echo anchor('home/employee_manage', 'Cancel', array('title' => 'Cancel', 'class' => 'btn span4')); ?>
</div>
</div>
</fieldset>
</form>
