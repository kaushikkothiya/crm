                            ...
                            <td align="center" valign="top" bgcolor="#FFFFFF"><table width="94%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:20px;">
                                            <p style="margin: 0px; width:600px;" >Dear customer <b><?php echo $fname;?>&nbsp;<?php echo $lname;?></b>,</p>
                                            <p>Welcome and Thank you for choosing our company to find your ideal property Your Customer ID: <?php echo $id;?>.</p>
                                            <p>any further info call: 8000 7000</p>
                                            <p>Thanks & Regards</p>
                                            <p>Monopolion Team</p>
