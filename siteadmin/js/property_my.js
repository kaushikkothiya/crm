...
$('#manage_form').validate({
                ...
                messages:{
                         ...
                         email:{required:"Email address can not be blank",email:"Enter valid email address"},
                         ...
                         address:{/*required:"address must not be  empty",*/maxlength:"address can not enter more then 500 characters"},     
                         rent_price:{required:"Rent price can not be blank",number:"Rent price  must contain only digits"},     
                         sale_price:{required:"Selling price can not be blank",number:"Selling Price enter only digits"},     
                         size:{required:"Size can not be blank",number:"Size enter only digits"},     
                         reference_no:{required:"Reference number can not be blank",remote: 'Your reference number is already exits'},
                         image:{required:"Image can not be blank",accept:"Only images with type jpg/png/gif are allowed"},
                         bedrooms:{required:"Please select bedrooms"},
                         //bathrooms:{required:"Please select bathrooms"},
                         link_url:{required:"URL link can not be blank",url:"Please enter a valid URL link1"},
