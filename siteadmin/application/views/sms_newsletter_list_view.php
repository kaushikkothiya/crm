            ...
            <div class="row-fluid">
                <div class="span12">
                    <ul class="breadcrumb">
                        ...
                        <li><?php echo anchor('home/sms_newsletter_list', 'SMS Newsletter', "title='SMS Newsletter'"); ?>
                            <span class="divider">
                            </span></li>
						<li style="float:right;"><a href="sms_newsletter"><input type="button" value="Add New" /></a></li>
                    </ul>
                </div>
            </div>
