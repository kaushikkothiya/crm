            ...
            foreach ($data['values'] as $key => $value) {
                ...
                if ($value['G'] == "Yes") {
                    ...
                    if(!$agent_id){
                        ...
                        $message = 'Dear '.$user->fname.' '.$user->lname.',<br /><br />'." \r\n";
                        $message .= 'Welcome to '.$this->config->item('title').'. Your Agent account has been created.<br />'." \r\n";
                        $message .= 'You can login to you account using following credentials.<br />'." \r\n";
                        $message .= 'URL : '.base_url().'<br />'." \r\n";
                        $message .= 'Email : '.$agent_details['email'].'<br />'." \r\n";
                        $message .= 'Password : '.$agent_details['password'].'<br />'." \r\n";
                        $message .= 'You can login to you account using following credentials.<br />'." \r\n";
