...
<div class="container-fluid">
    <div class="row">
        <div class="main">
            <h1 class="page-header">Client Report</h1>
            <div class="row">
                <div class="col-sm-12">
                                ...
                                <div class="panel-body">
                                    <div>
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#added_clients" aria-controls="added_clients" role="tab" data-toggle="tab">Added Clients (<?php echo count($reporting['added_clients']); ?>)</a></li>
                                            <li role="presentation"><a href="#assigned_clients" aria-controls="assigned_clients" role="tab" data-toggle="tab">Assigned Clients (<?php echo count($reporting['assigned_clients']); ?>)</a></li>
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active" id="added_clients">
                                                <table class="table table-striped responsive-table">
                                                    ...
                                                    <tbody>
                                                        <?php if (count($reporting['added_clients']) > 0) { ?>
                                                            <?php foreach ($reporting['added_clients'] as $inquiry) { ?>
                                                                <tr>
                                                                    <td data-th='ID' hidden><div><?php echo $inquiry->id; ?></div></td>
                                                                    <td data-th='Registered Date'><div><?php echo date("d-M-Y", strtotime($inquiry->created_date)); ?></div></td>
                                                                    <td data-th='Name/Surname'><div><?php echo $inquiry->fname . ' ' . $inquiry->lname; ?></div></td>
                                                                    <td data-th='Email'><div><?php echo $inquiry->email; ?></div></td>
                                                                    <td data-th='Telephone'><div><?php echo $inquiry->mobile_no; ?></div></td>
                                                                    <td data-th="Reference From" style="text-align: right"><div><?php
                                                                        switch ($inquiry->reference_from){
                                                                            case 1:
                                                                                echo "Phone";
                                                                                break;
                                                                            case 2:
                                                                    ...
                                                                    ?></div></td>
                                                                    <td data-th="Property Status" style="min-width:60px"><div><?php 
                                                                        switch($inquiry->aquired){
                                                                            case 'sale':
                                                                                echo "Sale";
                                                                                break;
                                                                            case 'rent':
                                                                    ...
                                                                    ?></div></td>
                                                                    <td data-th='Status'><div><?php echo $inquiry->status; ?></div></td>
                                                                </tr>
                                                            <?php } ?>
                                                        <?php } else { ?>
                                            ...
                                            <div role="tabpanel" class="tab-pane" id="assigned_clients">
                                                <table class="table table-striped responsive-table">
                                                    <thead>
                                                        <tr>
                                                            <th hidden>Id</th>
                                                    ...
                                                    <tbody>
                                                        <?php if (count($reporting['assigned_clients']) > 0) { ?>
                                                            <?php foreach ($reporting['assigned_clients'] as $inquiry) { ?>
                                                                <tr>
                                                                    <td data-th='ID' hidden><div><?php echo $inquiry->id; ?></div></td>
                                                                    <td data-th='Registered Date'><div><?php echo date("d-M-Y", strtotime($inquiry->created_date)); ?></div></td>
                                                                    <td data-th='Name/Surname'><div><?php echo $inquiry->fname . ' ' . $inquiry->lname; ?></div></td>
