                ...
                <div class="col-sm-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <input type="hidden" id="property_id" name="property_id" value="<?php if (isset($id) && !empty($id)) {
                                echo $id;
                            } ?>">
...
<?php } ?>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="fild ">
                                                <div class="scroll-box">
                                                    <?php
                                                    $all_instrumental_facility = $this->inquiry_model->get_instrumental_facility();
...
<?php echo form_radio($room_size_id, '3', $checked3, ''); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <?php
                                    if ($id == "") {
                                        echo form_submit('pro_add', 'Add Property', "class='btn btn-sm btn-primary'");
                                        ?>&nbsp;&nbsp;<?php
                                        //echo form_submit('pro_add', 'Add Property With Extra images', "class='btn'");
                                    } else {
                                        echo form_submit('pro_up', 'Update Property', "class='btn btn-sm btn-primary'");
                                        ?>&nbsp;&nbsp;<?php
